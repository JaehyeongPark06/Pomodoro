...
import _apply_styled from "../styled/apply_styled";
import _button_apply from "../styled/button_apply";
import _button_closed from "../styled/button_close";
import _button_styled from "../styled/button_styled";
...
const Button = ({ type, buttonText = "", toggleVisibility }) => {
  ...
  if (type === "close") {
    return (
      <_button_closed onClick={toggleVisibility}>{buttonText}</_button_closed>
    );
  }
  ...
  if (type === "apply") {
    return (
      <_button_apply>
        <_apply_styled type="submit" value={buttonText} />
      </_button_apply>
    );
  } else {
    return null;
